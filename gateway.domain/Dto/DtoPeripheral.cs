...
{
    /// <summary>Transfer object to post / create new peripheral</summary>
    ...
    /// <summary>Transfer object to update new peripheral</summary>
    public class DtoPeripheralUpdateIn
    {
        /// <summary>Gateway database identifier</summary>
        /// <example>15</example> 
        [AllowNull, Range(0, UInt32.MaxValue)]
